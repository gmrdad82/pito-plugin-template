...
## Guards
- Do not touch: - `index.json`, `plugins/*`, `themes/*` (SH-16's, WK-14…17's, SH-25's, SH-26's) beyond linking to them. - The WIT files beyond byte-for-byte copies with their `SOURCE` record;
